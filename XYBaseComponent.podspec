#
# Be sure to run `pod lib lint XYBaseComponent.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/yulongCoder/XYBaseComponent-master.git', :tag => s.version.to_s }
